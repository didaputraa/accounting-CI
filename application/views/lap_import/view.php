...
$(document).ready(function(){
	...
	function tampil_data(e){
		...
		var string 	= "po_number="+po_number+"&th="+th+"&bln="+bln;
		var string2	= po_number+"/"+th+"/"+bln;
		...
		if(e=='cari'){
			...
			$.ajax({
				type	: 'POST',
				url		: "<?php echo site_url(); ?>/lap_import/view_data",
				data	: string,
				cache	: false,
			...
			window.open('<?php echo site_url();?>/lap_import/cetak_data/'+string2);
			return false();
		}
	}
