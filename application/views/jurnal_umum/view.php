...
$(".detail").click(function(){ //Memberikan even ketika class detail di klik (class detail ialah class radio button)
	if ($("input[name='mata_uang']:checked").val() == "berbeda" ) { //Jika radio button "berbeda" dipilih maka tampilkan form-inputan
	...
	$("#simpan").click(function(){
		...
		var string = "no_jurnal="+no_jurnal+"&tgl="+tgl+"&no_bukti="+no_bukti+
					"&ket="+ket+"&no_rek="+no_rek+"&kurs="+kurs+"&nilai="+nilai+"&rate="+rate+"&debet="+debet+"&kredit="+kredit;
		...
		let ceks = $("input=[name='mata_uang']:checked").val();
		...
		if(ceks){
			...
			alert('Harap pilih kurs terlebih dahulu');
		}
	});
...
Cari No.Jurnal/No.Rek/Keterangan : <input type="text" name="txt_cari" id="txt_cari" size="50" />
...
<tr>
	...
	<!--Radio Button Here -->
<td width="0%">
<!--<td width="5%"><input type="radio" name="mata_uang" value="sama" class="detail"> IDR
 
</td>-->

<td width="16%">
<input type="radio" name="mata_uang" value="berbeda" class="detail">Kurs
</td>
...
<!--<p>Kurs<br />
<input type="text" name="kurs"></p>-->
<form action="jurnal_umum/simpan" method="get">
      <p>Kurs
	  <select name='agama' id="kurs">
...
<p>Nilai<br />
<input type="text" name="nilai" id="nilai"></p>
<p>Rate<br />
<input type="text" name="rate" id="rate"></p>
 </div> </td>
