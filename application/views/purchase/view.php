...
$(document).ready(function(){
	...
	$("#simpan").click(function(){
		...
		if(nama_rek.length==0){
			//alert("Maaf, Nama purchase tidak boleh kosong");
			$.messager.show({
				title:'Info',
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/purchase/simpan",
			data	: string,
			cache	: false,
	...
	$("#tambah_data").click(function(){
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/purchase/tambah",
			cache	: false,
			success	: function(data){
				kosong();
				$("#no_rek").focus();
	...
	$("#kembali").click(function(){
		window.location.assign('<?php echo base_url();?>index.php/purchase');
		return false();
	});
});
...
function editData(id){
	...
	$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/purchase/edit",
			data	: string,
			cache	: true,
			dataType : "json",
			success	: function(data){
...
<div id="view">
    ...
    <form name="form" method="post" action="<?php echo base_url();?>index.php/purchase">
...
<?php
	if($data->num_rows()>0){
    	...
    	<tr>
            ...
            <td align="center" width="150" ><?php echo $db['date']; ?></td>
            <td align="center" width="150" ><?php echo $db['vendor']; ?></td>
            <td align="center" width="150" ><?php echo $db['raw_material']; ?></td>
            <td align="center" width="150" ><?php echo $db['item']; ?></td>
            <td align="center" width="150" ><?php echo $db['qty']; ?></td>
            <td align="center" width="150" ><?php echo $db['ammount']; ?></td>
            <!--<td align="center" width="80">-->
            <!--<?php echo "<a href='javascript:editData(\"{$db['no_rek']}\")'>";?>
			<img src="<?php echo base_url();?>asset/images/ed.png" title='Edit'>
			</a>
            <a href="<?php echo base_url();?>index.php/purchase/hapus/<?php echo $db['no_rek'];?>"
