...
<div id="view">
    ...
    <a href="<?php echo base_url();?>index.php/export">
    <button type="button" name="refresh" id="refresh" class="easyui-linkbutton" data-options="iconCls:'icon-reload'">Refresh</button>
    </a>
    </div>
    <div style="float:right; padding-bottom:5px;">
    <form name="form" method="post" action="<?php echo base_url();?>index.php/export">
...
<?php
	if($data->num_rows()>0){
    	...
    	<tr>
            ...
            <td align="center" width="150" ><?php echo $db['peb_number']; ?></td>
            <td align="center" width="150" ><?php echo $db['peb_date']; ?></td>
            <td align="center" width="150" ><?php echo $db['invoice_no']; ?></td>
            <td align="center" width="150" ><?php echo $db['customer_name']; ?></td>
            <td align="center" width="150" ><?php echo $db['item']; ?></td>
            <td align="center" width="150" ><?php echo $db['qty']; ?></td>
            <td align="center" width="150" ><?php echo $db['cnf_ammount']; ?></td>
            <td align="center" width="150" ><?php echo $db['fob_ammount']; ?></td>
