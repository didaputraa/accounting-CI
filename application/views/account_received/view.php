...
$(document).ready(function(){
	...
	$("#simpan").click(function(){
		...
		if(nama_rek.length==0){
			//alert("Maaf, Nama account_received tidak boleh kosong");
			$.messager.show({
				title:'Info',
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/account_received/simpan",
			data	: string,
			cache	: false,
	...
	$("#tambah_data").click(function(){
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/account_received/tambah",
			cache	: false,
			success	: function(data){
				kosong();
				$("#no_rek").focus();
	...
	$("#kembali").click(function(){
		window.location.assign('<?php echo base_url();?>index.php/account_received');
		return false();
	});
});
...
function editData(id){
	...
	$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/account_received/edit",
			data	: string,
			cache	: true,
			dataType : "json",
			success	: function(data){
...
<div id="view">
    ...
    <a href="<?php echo base_url();?>index.php/account_received">
    <button type="button" name="refresh" id="refresh" class="easyui-linkbutton" data-options="iconCls:'icon-reload'">Refresh</button>
    </a>
    </div>
    <div style="float:right; padding-bottom:5px;">
    <form name="form" method="post" action="<?php echo base_url();?>index.php/account_received">
...
<?php
	if($data->num_rows()>0){
    	...
    	<tr>
            ...
            <a href="<?php echo base_url();?>index.php/account_received/hapus/<?php echo $db['no_rek'];?>"
