...
<div id="view">
    ...
    <a href="<?php echo base_url();?>index.php/warehouse">
    <button type="button" name="refresh" id="refresh" class="easyui-linkbutton" data-options="iconCls:'icon-reload'">Refresh</button>
    </a>
    </div>
    <div style="float:right; padding-bottom:5px;">
    <form name="form" method="post" action="<?php echo base_url();?>index.php/warehouse">
...
<?php
	if($data->num_rows()>0){
    	...
    	<tr>
            ...
            <td align="center" width="150" ><?php echo $db['btb_no']; ?></td>
